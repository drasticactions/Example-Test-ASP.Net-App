...
namespace ApplicationSite
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            //   appSecret: "");
            /*
             NOTE: Since this is getting put into a public git, these keys should be moved out into some other file that 
             * won't be committed. However, since I won't be using these keys for any purpose other then this test
             * (And I don't want anyone to think Oauth does not work because of a bug, rather than me leaving out the keys on purpose, I will leave them here.
